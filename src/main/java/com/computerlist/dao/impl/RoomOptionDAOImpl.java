...
public class RoomOptionDAOImpl implements RoomOptionDAO {
    ...
    private RoomOption extractRoomOption(ResultSet rs) throws SQLException {
        RoomOption config = new RoomOption();
        config.setId(rs.getInt("id"));
        config.setRoomType(rs.getString("room_type"));
        config.setCapacity(rs.getInt("capacity"));
        config.setBed_type(rs.getString("bed_type"));
        config.setBed_count(rs.getInt("bed_count"));
        config.setPriceMultiplier(rs.getDouble("price_multiplier"));
        return config;
    }
}